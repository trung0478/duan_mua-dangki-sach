...
<div class="cart-main-area pt-70px pb-100px">
    <div class="container">
        ...
        <form class="my-4" action="?act=update_dh" method="post">
            <input type="hidden" name="id_order" value="<?=$id_donhang?>">
            <label for="">Trạng thái</label>
            <select class="form-control" name="trang_thai" id="">
                <option value="0" <?= ($trangthai == 0) ? "selected" : "" ?>>Đã hủy đơn</option>
                <option value="1" <?= ($trangthai == 1) ? "selected" : "" ?>>Chưa xử lý</option>
                <option value="2" <?= ($trangthai == 2) ? "selected" : "" ?>>Đã xác nhận</option>
                <option value="3" <?= ($trangthai == 3) ? "selected" : "" ?>>Đang giao hàng</option>
                <option value="4" <?= ($trangthai == 4) ? "selected" : "" ?>>Đã giao hàng</option>
                <option value="5" <?= ($trangthai == 5) ? "selected" : "" ?>>Đã nhận hàng</option>
            </select>
            <br>
            <button type="submit" name="sua_tt" class="btn btn-primary">Sửa </button>
        </form>
    </div>
</div>
<!-- Cart Area End -->