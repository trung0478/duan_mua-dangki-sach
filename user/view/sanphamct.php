                            ...
                            <div class="product-info-main">
                                ...
                                <div class="product-social-links">
                                    ...
                                    <div class="product-addto-links-text">
                                        <p>Powerwalking to the gym or strolling to the local coffeehouse, the Savvy
                                            Shoulder Tote lets you stash your essentials in sporty style! A top-loading
                                            compartment provides quick and easy access to larger items, while zippered
                                            pockets on the front and side hold cash, credit cards and phone.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-active-2 owl-carousel">
                        ...
                        <div class="product-wrapper">
                            <div class="product-img">
                                <a href="#">
                                    <img src="https://htmldemo.net/koparion/koparion/img/product/1.jpg" alt="book"
                                        class="primary" />
                                </a>
                        ...
                        <div class="product-wrapper">
                            <div class="product-img">
                                <a href="#">
                                    <img src="https://htmldemo.net/koparion/koparion/img/product/3.jpg" alt="book"
                                        class="primary" />
                                </a>
                                <div class="quick-view">
                                    <a class="action-view" href="#" data-bs-target="#productModal"
                        ...
                        <div class="product-wrapper">
                            <div class="product-img">
                                <a href="#">
                                    <img src="https://htmldemo.net/koparion/koparion/img/product/5.jpg" alt="book"
                                        class="primary" />
                                </a>
                                <div class="quick-view">
                                    <a class="action-view" href="#" data-bs-target="#productModal"
                        ...
                        <div class="product-wrapper">
                            <div class="product-img">
                                <a href="#">
                                    <img src="https://htmldemo.net/koparion/koparion/img/product/7.jpg" alt="book"
                                        class="primary" />
                                </a>
                                <div class="quick-view">
                                    <a class="action-view" href="#" data-bs-target="#productModal"
                ...
                <div class="shop-left">
                    ...
                    <div class="random-area mb-30">
                        <div class="product-active-2 owl-carousel">
                            <div class="product-total-2">
                                <div class="single-most-product bd mb-18">
                                    <div class="most-product-img">
                                        <a href="#"><img src="https://htmldemo.net/koparion/koparion/img/product/20.jpg"
                                                alt="book" /></a>
                                    </div>
                                ...
                                <div class="single-most-product bd mb-18">
                                    <div class="most-product-img">
                                        <a href="#"><img src="https://htmldemo.net/koparion/koparion/img/product/21.jpg"
                                                alt="book" /></a>
                                    </div>
                                    <div class="most-product-content">
                                        <div class="product-rating">
                                ...
                                <div class="single-most-product">
                                    <div class="most-product-img">
                                        <a href="#"><img src="https://htmldemo.net/koparion/koparion/img/product/22.jpg"
                                                alt="book" /></a>
                                    </div>
                                    <div class="most-product-content">
                                        <div class="product-rating">
                            ...
                            <div class="product-total-2">
                                <div class="single-most-product bd mb-18">
                                    <div class="most-product-img">
                                        <a href="#"><img src="https://htmldemo.net/koparion/koparion/img/product/23.jpg"
                                                alt="book" /></a>
                                    </div>
                                    <div class="most-product-content">
                                        <div class="product-rating">
                                ...
                                <div class="single-most-product bd mb-18">
                                    <div class="most-product-img">
                                        <a href="#"><img src="https://htmldemo.net/koparion/koparion/img/product/24.jpg"
                                                alt="book" /></a>
                                    </div>
                                    <div class="most-product-content">
                                        <div class="product-rating">
                    ...
                    <div class="banner-area mb-30">
                        <div class="banner-img-2">
                            <a href="#"><img src="https://htmldemo.net/koparion/koparion/img/banner/33.jpg"
                                    alt="banner" /></a>
                        </div>
                    </div>
